...
import thcoder from "./theme/thcoder.json" with { type: "json" }
  ...
  init: (props: { mode: "dark" | "light" }) => {
    ...
    setStore(
      produce((draft) => {
        ...
        draft.mode = mode
        draft.lock = lock
        const active = config.theme ?? kv.get("theme", "thcoder")
    ...
    const values = createMemo(() => {
      ...
      return resolveTheme(store.themes.thcoder, store.mode)
    })
