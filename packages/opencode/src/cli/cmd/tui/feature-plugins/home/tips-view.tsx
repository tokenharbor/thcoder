...
const TIPS: Tip[] = [
  ...
  "Place TUI settings in {highlight}~/.config/thcoder/tui.json{/highlight} for global config",
  ...
  "Use {highlight}thcoder run{/highlight} for non-interactive scripting",
  "Use {highlight}thcoder --continue{/highlight} to resume the last session",
  "Use {highlight}thcoder run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}thcoder serve{/highlight} for headless API access to OpenCode",
  "Use {highlight}thcoder run --attach{/highlight} to connect to a running server",
  "Run {highlight}thcoder upgrade{/highlight} to update to the latest version",
  "Run {highlight}thcoder auth list{/highlight} to see all configured providers",
  "Run {highlight}thcoder agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}thcoder github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}thcoder debug config{/highlight} to troubleshoot configuration",
